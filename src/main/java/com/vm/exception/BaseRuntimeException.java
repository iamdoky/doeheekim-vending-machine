...
public class BaseRuntimeException extends RuntimeException {
    ...
    public BaseRuntimeException(Errors errors, Throwable cause) {
    ...
    public BaseRuntimeException(Errors errors, String addedMessage, HttpStatus httpStatus) {
        super(errors.getMessage());

        this.errorCode = errors.getCode();
        this.errorMessage = errors.getMessage() + addedMessage;
        this.errorStatus = httpStatus.value();
    }
